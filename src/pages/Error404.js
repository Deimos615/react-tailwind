...
const Error404 = () => {
  return (
    <div className=" w-full flex items-center justify-center error_section">
      <div className='flex flex-col items-center gap-6'>
        <div className=' flex flex-col items-center' style={{ gap: '-50px' }}>
          <div className=' font-sans text-100 sm:text-300 font-extrabold capitalize error_text'>
            404
          </div>
          <div className=' font-sans font-extrabold capitalize error_msg text-black'>
            Page Not Found
          </div>
          <div className=' font-sans text-gray-700 text-xl font-normal error_content capitalize'>
            The page you are looking for doesn't exist or has been moved.
          </div>
          <Link to="/">
            <div className='go_home_btn text-white flex items-center justify-between space-x-3 mt-12' >
              Go To Home
